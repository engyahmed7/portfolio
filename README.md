...
A modern, interactive developer portfolio showcasing professional experience, technical skills, and complex projects. Built with cutting-edge web technologies and featuring smooth animations.
...
```bash
git clone https://github.com/engyahmed7/portfolio.git
cd portfolio
```
...
- **Project Showcase**
  - Filterable project cards with tech tags
  - Live demo and GitHub links
  - Image carousels with hover effects
